...
/***************************************************************************************************
 ...
 I have no idea how many people will ever see this, but seeing as this tool could be useful for
 others working on CHUMP I may send it to some people who ask.
...
void draw() {
  ...
  //This entire section adds the little blinking | character where you are typing
  ...
  if (mouseX > 650 && mouseX < 675 && mouseY > 130 && mouseY < 155) {
    fill(150, 150, 255); //Highlight the button whe.... you get it
  } else {
    fill(100, 100, 200);
  }
  rect(650, 130, 25, 25);
  ...
  fill(150, 150, 255);
  //Arrows for line selection buttons
}
