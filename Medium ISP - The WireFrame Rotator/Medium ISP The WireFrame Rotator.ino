...
void loop() {
  ...
  if (first) {
    ...
    for (int i = 0; i < numLines; i++) {
      //Once for every line
      int x1 = screenCoords[edgeTable[i][0]][0] * scale + 80;
      int y1 = screenCoords[edgeTable[i][0]][1] * scale + 64;

      int x2 = screenCoords[edgeTable[i][1]][0] * scale + 80;
      int y2 = screenCoords[edgeTable[i][1]][1] * scale + 64;
    ...
    for (int i = 0; i < numLines; i++) {
      //For every line...
      int x1 = backupScreenCoords[edgeTable[i][0]][0] * scale + 80;
      int y1 = backupScreenCoords[edgeTable[i][0]][1] * scale + 64;

      int x2 = backupScreenCoords[edgeTable[i][1]][0] * scale + 80;
      int y2 = backupScreenCoords[edgeTable[i][1]][1] * scale + 64;
